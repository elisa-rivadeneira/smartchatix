...
<div class="container_politica">
     <h1>Condiciones de Servicio de Elixa English</h1>
    <p><strong>Fecha de entrada en vigor:</strong> [Fecha]</p>

    <h2>1. Introducción</h2>
    <p>Bienvenido a <strong>Elixa English</strong>. Al utilizar nuestra aplicación, usted acepta cumplir con estas Condiciones de Servicio. Si no está de acuerdo con ellas, no debe utilizar el servicio.</p>

    <h2>2. Período de Prueba y Suscripción</h2>
    <ul>
        <li>El usuario tiene derecho a un período de prueba gratuito de <strong>7 días</strong>.</li>
        <li>Una vez finalizado el período de prueba, se aplicará un cargo de <strong>20 dólares mensuales</strong>.</li>
        <li>La suscripción permite el acceso ilimitado a la aplicación mientras se mantenga el pago activo.</li>
    </ul>

    <h2>3. Pagos y Facturación</h2>
    <p>El pago de la suscripción se realizará automáticamente cada mes mediante el método de pago registrado. El usuario puede cancelar en cualquier momento antes del próximo ciclo de facturación para evitar cargos adicionales.</p>
    ...
    <ul>
        ...
        <li>No se ofrecen reembolsos por pagos ya realizados.</li>
    </ul>

    <h2>5. Modificaciones del Servicio</h2>
    <p>Nos reservamos el derecho de modificar o discontinuar el servicio en cualquier momento. Se notificará a los usuarios con antelación en caso de cambios importantes.</p>

    <h2>6. Contacto</h2>
    <p>Para cualquier consulta, puede contactarnos en: <strong>[correo electrónico de contacto]</strong></p>

    <p>Gracias por utilizar <strong>Elixa English</strong>.</p>
    </div>
</section>
