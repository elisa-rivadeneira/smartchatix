...
<body>
  ...
  <!-- <video autoplay muted loop poster="bg-smartchix.jpg" class="video-bg">
    <source src="images/elixa.webm" type="video/webm">
    Your browser does not support the video tag.
  </video> -->

  <div class="hero-content animate">
    <div class="text-container">
      <h1>Habla Ingles Rapidamente con la IA</h1>
      <p>Elixa es la herramienta perfecta basada en IA para mejorar tu inglés a tu propio ritmo.</p>
      <a href="#contact" id="start-chatbot2" class="btn btn-primary" onclick='pedirprueba()'>Usalo gratis por 7 dias</a>
    </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="feature-box">
                    ...
                    <h3>Conversaciones interactivas</h3>
                    <p>Con IA en tiempo real</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="feature-box">
                    ...
                    <p>De pronunciación y gramática</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="feature-box">
                    <img src="images/integracion.jpg" alt="Icono de integración">
                    <h3>Lecciones adaptadas</h3>
                    <p>a tu nivel y objetivos</p>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="feature-box">
                    ...
                    <p>Aprende cuando quieras y a tu ritmo</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pricing-table" id="integracion">
                    <h2>¿Tienes un nivel intermedio?</h2><h3>¿Necesitas hablar inglés rápido para viajar o trabajar?</h3>
                    <p>
                     Con Elixa, aprender inglés es más fácil y motivador que nunca. Nuestro tutor de IA te guía con sesiones personalizadas, te corrige en tiempo real y te impulsa a mejorar día a día.
                    </p>
                    <a href="#contact" id="start-chatbot3" class="btn btn-primary" onclick="pedirprueba()">Pruebalo Gratis por 7 dias</a>
                </div>
            </div>
        </div>
    </div>
